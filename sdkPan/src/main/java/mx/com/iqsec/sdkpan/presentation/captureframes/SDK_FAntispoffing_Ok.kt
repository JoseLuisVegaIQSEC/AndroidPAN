...
import mx.com.iqsec.sdkpan.databinding.SdkFAntispoffingOkBinding
...
class SDK_FAntispoffing_Ok : SDK_PAN_BFragment() {

    private var _binding: SdkFAntispoffingOkBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = SdkFAntispoffingOkBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initListeners() {
        ...
        binding.btnEnter.setOnClickListener {
            if (onStateToolbar?.hasConnection() == false) {
                handleConectionAttemps() { actionFinish(it, SDK_Constants.TEST_LIFE_OK_STEP) }
                return@setOnClickListener
            }

            onNavigate(R.id.action_SDK_FAntispoffing_Ok_to_nav_SDK_FNoticeINE)
        }
    }
